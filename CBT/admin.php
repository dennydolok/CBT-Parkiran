...
<?php 
  ...
  $perintah = new oop();
  $kd_admin = "AD" . rand(001,200);
  $form="admin.php";
  @$table = "tbl_admin";
  @$encode = base64_encode($_POST['password']); 
  @$isi= "kd_admin = 'kd_admin', nama_admin='$_POST[nama_admin]', username='$_POST[username]', password = '$encode', shift = '$_POST[shift]'";
  if (isset($_POST['simpan'])) {
  	if ($_POST['nama_admin'] == "" || $_POST['username'] == "" || $_POST['password'] == "") {
  ...
  if (isset($_POST['update'])) {
    $deco = base64_decode($_POST['password']);
    $sql = "UPDATE tbl_admin SET nama_admin = '$_POST[nama_admin]', username = '$_POST[username]', shift = '$_POST[shift]', password = $deco WHERE kd_admin = '$_GET[id]' ";
    $query = mysqli_query($con,$sql);
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" isi-toggle="modal" isi-target="#exampleModal">
  ...
  <div class="content-wrapper">
    <div class="container-fluid" style="height: 100%;">
      ...
      <div class="card mb-3">
        ...
        <option value="" readonly disabled>Pilih Shift</option>     
